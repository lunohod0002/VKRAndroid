...
class MapViewModel(
    ...
    val markers: List<MapMarker> = listOf(
        ...
        MapMarker(StationCoordinates(55.744701, 37.566815), "Киевская", 3),
        MapMarker(StationCoordinates(55.747751, 37.583834), "Смоленская", 3),
        ...
        MapMarker(StationCoordinates(55.776776, 37.585257), "Белорусская", 5),
