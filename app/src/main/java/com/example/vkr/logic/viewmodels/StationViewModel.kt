...
//                if (cell.station == "Краснопресненская" && branch == "Кольцевая") {
...
//                        )
//                    )
//                } else if (cell.station == "Белорусская" && branch == "Кольцевая") {
//                    resultLiveMutable.postValue(
//                        Station(
//                            1,
//                            "Белорусская",
...
//                            ),
//                            listOf("https://samplelib.com/preview/mp4/sample-20s-360p.mp4"),
//                            listOf("https://samplelib.com/mp3/sample-12s.mp3"),
//                            listOf(
//                                StationAttractionInfo(
//                                    1,
